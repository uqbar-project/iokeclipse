...
public class IokeConsoleView extends ViewPart implements IokeConsoleListener {
	...
	try {
	    Object result = getRuntime().evaluateString(this.inputTextArea.getText() + "\n");
	...
	// this is totally non-performant. We should connecto the stream directly to the StyledTextContent
    ...
    @Override
    public void dispose() {
	getConsole().removeListener(this);
	super.dispose();
    }
